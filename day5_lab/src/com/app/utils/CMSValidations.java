...
//1. parse string(plan) -- > enum
	...
	public static Customer signin(String email, String password, List<Customer> customers) throws CMSException {
	    ...
	    throw new CMSException("Invalid email or password"); // Throw exception if no matching customer found
	}

	public static Customer changepassword(String email, String oldPassword, String newPassword, List<Customer> customers) throws CMSException {
	    for (Customer customer : customers) {
	        if (customer.getEmail().equals(email)) {
