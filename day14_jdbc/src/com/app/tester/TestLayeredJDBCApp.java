			...
			while (!exit) {
				...
				try {
					...
					case 4:
						...
						String u= userDao.updatePassword(sc.next(), sc.next(),sc.next());
						System.out.println(u);
						break;
					case 5:
						System.out.println("enetr the userid which have to delete: ");
						int i=userDao.deleteUser(sc.nextInt());
